...
public class MMD4MecanimBulletPhysics : MonoBehaviour
{
	...
	public class MMD4MecanimBulletBridge : MMD4MecanimInternal.Bullet.IBridge
	{
		...
		{
			System.Threading.Mutex				_lockMutex = new System.Threading.Mutex();
			...
			class Queue
			{
				...
				public System.Threading.ManualResetEvent processedEvent;
				...
				public Queue( System.Action function )
				{
					...
					this.queueID = 0;
					this.uniqueID = 0;
					this.processedEvent = new System.Threading.ManualResetEvent(false);
				}
	...
	public static MMD4MecanimBulletPhysics instance
	{
		get {
			#if MMD4MECANIM_DEBUG
			Debug.Log("MMD4MecanimBulletPhysics.instance");
			#endif
			if( _instance == null ) {
				_instance = (MMD4MecanimBulletPhysics)MonoBehaviour.FindObjectOfType( typeof(MMD4MecanimBulletPhysics) );
				if( _instance == null ) {
					#if MMD4MECANIM_DEBUG
					Debug.Log("MMD4MecanimBulletPhysics.instance: Not found instance. Create MMD4MecanimBulletPhysics");
					#endif
					...
					if( _instance == null ) {
						#if MMD4MECANIM_DEBUG
						Debug.Log("MMD4MecanimBulletPhysics.instance: Force binded instance.");
						#endif
						_instance = instance;
					}
				}
	...
	private void _Initialize()
	{
		...
		#if !NOUSE_BULLETXNA_UNITY
		#if UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX || UNITY_ANDROID || UNITY_IPHONE
		#if UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6
		_isUseBulletXNA = !Application.HasProLicense();
		#else // Unity 5.0 or laster.
	...
	public class World
	{
		...
		{
			#if MMD4MECANIM_DEBUG
			_instanceID = MMD4MecanimBulletPhysics._instanceID;
			++MMD4MecanimBulletPhysics._instanceID;
			Debug.Log( "MMD4MecanimBulletPhysics.World.World() " + _instanceID );
			#endif
		}
		...
		{
			#if MMD4MECANIM_DEBUG
			Debug.Log( "MMD4MecanimBulletPhysics.World.Create() " + _instanceID );
			#endif
		...
		{
			#if MMD4MECANIM_DEBUG
			Debug.Log( "MMD4MecanimBulletPhysics.World.Destroy() " + _instanceID );
			#endif
	...
	public class MMDModel
	{
		...
		int[]									_fullBodyIKBoneIDList = null;
		Vector3[]								_fullBodyIKPositionList = null;
		Quaternion[]							_fullBodyIKRotationList = null;
		...
		int[]									_updateFullBodyIKFlagsList = null;
		float[]									_updateFullBodyIKTransformList = null;
		float[]									_updateFullBodyIKWeightList = null;
		...
		public int[]		fullBodyIKBoneIDList			{ get { return _fullBodyIKBoneIDList; } }
		public Vector3[]	fullBodyIKPositionList			{ get { return _fullBodyIKPositionList; } }
		public Quaternion[]	fullBodyIKRotationList			{ get { return _fullBodyIKRotationList; } }

		public int[]		updateFullBodyIKFlagsList		{ get { return _updateFullBodyIKFlagsList; } }
		public float[]		updateFullBodyIKTransformList	{ get { return _updateFullBodyIKTransformList; } }
		public float[]		updateFullBodyIKWeightList		{ get { return _updateFullBodyIKWeightList; } }
		...
		public enum UpdateFlags
		{
			...
			FullBodyIKEnabled					= 0x00000010, // from Unity
		}
		...
		public MMDModel()
		{
			...
			_instanceID = MMD4MecanimBulletPhysics._instanceID;
			++MMD4MecanimBulletPhysics._instanceID;
			Debug.Log("MMD4MecanimBulletPhysics.MMDModel.MMDModel() " + _instanceID );
			#endif
		}
		...
		{
			#if MMD4MECANIM_DEBUG
			Debug.Log("MMD4MecanimBulletPhysics.MMDModel.Create() " + _instanceID );
			#endif
			...
			#if MMD4MECANIM_DEBUG
			Debug.Log("MMD4MecanimBulletPhysics.MMDModel.Create() PhaseA" );
			#endif
			...
			if( joinLocalWorld ) {
				...
				optimizeSettings = localWorldProperty.optimizeSettings;
			} else {
				if( MMD4MecanimBulletPhysics.instance != null ) {
					joinWorld = MMD4MecanimBulletPhysics.instance.globalWorld;
				}
				...
				optimizeSettings = joinWorld.worldProperty.optimizeSettings;
			}
			...
			property.Write( "optimizeSettings", optimizeSettings );
			...
			#if MMD4MECANIM_DEBUG
			Debug.Log("MMD4MecanimBulletPhysics.MMDModel.Create() PhaseB" );
			#endif
			...
			#if MMD4MECANIM_DEBUG
			Debug.Log("MMD4MecanimBulletPhysics.MMDModel.Create() PhaseC" );
			#endif

			if( mmdModelPtr != IntPtr.Zero ) {
				#if MMD4MECANIM_DEBUG
				Debug.Log("MMD4MecanimBulletPhysics.MMDModel.Create() PhaseD" );
				#endif
				...
				#if MMD4MECANIM_DEBUG
				{
					var gch_fullBodyIKBoneIDList	= MMD4MecanimCommon.MakeGCHValues( _fullBodyIKBoneIDList );
					var gch_fullBodyIKPositionList	= MMD4MecanimCommon.MakeGCHValues( _fullBodyIKPositionList );
					var gch_fullBodyIKRotationList	= MMD4MecanimCommon.MakeGCHValues( _fullBodyIKRotationList );
					_GetFullBodyIKDataMMDModel( this.mmdModelPtr,
					                           gch_fullBodyIKBoneIDList,
					                           gch_fullBodyIKPositionList,
					                           gch_fullBodyIKRotationList,
					                           FullBodyIKTargetMax );
					gch_fullBodyIKRotationList.Free();
					gch_fullBodyIKPositionList.Free();
					gch_fullBodyIKBoneIDList.Free();
				}
				#endif

				#if MMD4MECANIM_DEBUG
				Debug.Log("MMD4MecanimBulletPhysics.MMDModel.Create() PhaseE" );
				#endif
				return true;
			} else {
				if( localWorld != null ) {
		...
		public const int FullBodyIKTargetMax = MMD4MecanimData.FullBodyIKTargetMax;
		...
		void _PrepareWork( MMD4MecanimModel model )
		{
			...
			_fullBodyIKBoneIDList					= new int[FullBodyIKTargetMax];
			_fullBodyIKPositionList					= new Vector3[FullBodyIKTargetMax];
			_fullBodyIKRotationList					= new Quaternion[FullBodyIKTargetMax];
			for( int i = 0; i != FullBodyIKTargetMax; ++i ) {
			...
			_updateFullBodyIKFlagsList				= new int[FullBodyIKTargetMax];
			_updateFullBodyIKTransformList			= new float[FullBodyIKTargetMax * MMD4MecanimData.FullBodyIKTransformElements];
			_updateFullBodyIKWeightList				= new float[FullBodyIKTargetMax];
			for( int i = 0; i != FullBodyIKTargetMax; ++i ) {
				_updateFullBodyIKWeightList[i]		= 1.0f;
			}
		}
		...
		{
			#if MMD4MECANIM_DEBUG
			Debug.Log( "MMD4MecanimBulletPhysics.MMDModel.Destroy() " + _instanceID );
			#endif
		...
		public void Update()
		{
			...
			updateFlags |= this.model.fullBodyIKEnabled ? (int)UpdateFlags.FullBodyIKEnabled : 0;
			...
			if( _isDirtyPreUpdate ) {
				...
				if( !preUpdatedBulletXNA && this.mmdModelPtr != IntPtr.Zero ) {
					...
					var gch_updateFullBodyIKFlagsList	= MMD4MecanimCommon.MakeGCHValues( _updateFullBodyIKFlagsList );
					var gch_updateFullBodyIKWeightList	= MMD4MecanimCommon.MakeGCHValues( _updateFullBodyIKWeightList );
					...
					_PreUpdateMMDModel( this.mmdModelPtr, updateFlags,
					                   ...
					                   gch_updateFullBodyIKFlagsList, gch_updateFullBodyIKWeightList, gch_updateFullBodyIKWeightList.length );

					gch_updateFullBodyIKWeightList.Free();
					gch_updateFullBodyIKFlagsList.Free();
			...
			if( this.mmdModelPtr != IntPtr.Zero ) {
				...
				var gch_updateMorphWeightList			= MMD4MecanimCommon.MakeGCHValues( _updateMorphWeightList );
				var gch_updateFullBodyIKFlagsList		= MMD4MecanimCommon.MakeGCHValues( _updateFullBodyIKFlagsList );
				var gch_updateFullBodyIKTransformList	= MMD4MecanimCommon.MakeGCHValues( _updateFullBodyIKTransformList );
				var gch_updateFullBodyIKWeightList		= MMD4MecanimCommon.MakeGCHValues( _updateFullBodyIKWeightList );
				...
				_UpdateMMDModel( this.mmdModelPtr, updateFlags,
					...
					gch_updateIKWeightList, gch_updateIKWeightList.length,
					gch_updateMorphWeightList, gch_updateMorphWeightList.length,
				    gch_updateFullBodyIKFlagsList, gch_updateFullBodyIKTransformList, gch_updateFullBodyIKWeightList, gch_updateFullBodyIKWeightList.length );

				gch_updateFullBodyIKWeightList.Free();
				gch_updateFullBodyIKTransformList.Free();
				gch_updateFullBodyIKFlagsList.Free();
				gch_updateMorphWeightList.Free();
				gch_updateIKWeightList.Free();
				gch_updateRigidBodyFlagsList.Free();
	...
	void Awake()
	{
		...
		// Memo: Unstable in WebPlayer and WebGL.
		// Don't rewrite this.
		Debug.LogWarning( "Not supported platform.(Destroy this.)" );
		...
		if( _instance == null ) {
			#if MMD4MECANIM_DEBUG
			Debug.Log("MMD4MecanimBulletPhysics.Awake(): Binded instance. " + this.gameObject.name );
			#endif
			_instance = this;
		} else {
			if( _instance != this ) {
				#if MMD4MECANIM_DEBUG
				Debug.LogError("MMD4MecanimBulletPhysics.Awake(): Destroy instance." + this.gameObject.name );
				#endif
				#if UNITY_EDITOR
	...
	void _InternalUpdate()
	{
		if( _isAwaked ) {
			...
			for( int i = 0; i != _rigidBodyList.Count; ++i ) {
				_rigidBodyList[i].LateUpdate();
			}
			for( int i = 0; i != _mmdModelList.Count; ++i ) {
				_mmdModelList[i].LateUpdate( Time.deltaTime );
			}
	...
	{
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: OnDestroy() instance is " + (_instance != null) + " Equally " + (_instance == this));
		#endif
		for( int i = 0; i != _rigidBodyList.Count; ++i ) {
			_rigidBodyList[i].Destroy();
		}
		for( int i = 0; i != _mmdModelList.Count; ++i ) {
			_mmdModelList[i].Destroy();
		}
	...
	{
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: DelayedAwake()");
		#endif
		yield return new WaitForEndOfFrame();
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: DelayedAwake(): Awaked.");
		#endif
		_isAwaked = true;
		yield break;
	}
	...
	{
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: CreateMMDModel()");
		#endif
		...
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: CreateMMDModel() Succeeded.");
		#endif
	...
	{
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: DestroyMMDModel()");
		#endif
		for( int i = 0; i < _mmdModelList.Count; ++i ) {
	...
	{
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: CreateRigidBody()");
		#endif
	...
	{
		#if MMD4MECANIM_DEBUG
		Debug.Log("MMD4MecanimBulletPhysics: DestroyRigidBody()");
		#endif
		for( int i = 0; i < _rigidBodyList.Count; ++i ) {
	...
	static int _GetFullBodyIKDataMMDModel(
		IntPtr mmdModelPtr,
	...
	{
		return MMD4MecanimBulletPhysicsGetFullBodyIKDataMMDModel(
			mmdModelPtr,
			fullBodyIKBoneID,
			fullBodyIKPositions,
			fullBodyIKRotations,
		...
		IntPtr iFullBodyIKValues, IntPtr fullBodyIKWeights, int fullBodyIKLength )
	{
		return MMD4MecanimBulletPhysicsPreUpdateMMDModel(
			...
			iFullBodyIKValues, fullBodyIKWeights, fullBodyIKLength );
	}
		...
		IntPtr iFullBodyIKValues, IntPtr fullBodyIKTransforms, IntPtr fullBodyIKWeights, int fullBodyIKLength )
	{
		MMD4MecanimBulletPhysicsUpdateMMDModel(
			...
			ikWeights, ikLength,
			morphWeights, morphLength,
			iFullBodyIKValues, fullBodyIKTransforms, fullBodyIKWeights, fullBodyIKLength );
	}
	...
	public static int  MMD4MecanimBulletPhysicsGetFullBodyIKDataMMDModel(
		IntPtr mmdModelPtr,
		IntPtr fullBodyIKBoneID,
		IntPtr fullBodyIKPositions,
		IntPtr fullBodyIKRotations,
		int fullBodyIKLength ) { return 0; }
	...
	public static int  MMD4MecanimBulletPhysicsPreUpdateMMDModel(
		...
		IntPtr ikWeights, int ikLength,
		IntPtr morphWeights, int morphLength,
		IntPtr iFullBodyIKValues, IntPtr fullBodyIKWeights, int fullBodyIKLength ) { return 0; }
