	...
	public class IK
	{
		...
		public IK( MMD4MecanimModel model, int ikID )
		{
			if( model == null || model.modelData == null || model.modelData.ikDataList == null ||
				...
				Debug.LogError( "model:" + (model != null)
				               + " modelData:" + (model != null && model.modelData != null)
				               + " ikDataList:" + (model != null && model.modelData != null && model.modelData.ikDataList != null)
				               + " ikID:" + ikID
				               + " Length:" + ((model != null && model.modelData != null && model.modelData.ikDataList != null) ? model.modelData.ikDataList.Length : 0) );
				return;
			}
	...
	void _CheckTransformIK()
	{
		...
		if( this.fullBodyIKTargetList != null ) {
			if( this.fullBodyIKTargetList.Length != MMD4MecanimData.FullBodyIKTargetMax ) {
				...
				for( int i = 0; i != this.fullBodyIKTargetList.Length; ++i ) {
					if( this.fullBodyIKTargetList[i] == null ) {
						this.fullBodyIKTargetList = null;
						break;
					}
				}
