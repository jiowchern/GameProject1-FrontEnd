...
{
	half3 tempColor = albedo * (half3)_LightColor0 * MMDLIT_ATTEN(atten) * MMDLIT_GLOBALLIGHTING;
	#ifdef AMB2DIFF_ON
	tempColor *= saturate(globalAmbient * _AmbientToDiffuse); // Feedback ambient for Unity5.
	#endif
	return tempColor;
}
