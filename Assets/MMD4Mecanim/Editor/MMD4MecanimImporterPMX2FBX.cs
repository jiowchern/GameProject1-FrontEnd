...
public partial class MMD4MecanimImporter : ScriptableObject
{
	...
	public class PMX2FBXConfig
	{
		...
		public class GlobalSettings
		{
			...
			public int					forceIKResetBoneFlag			= 0;
			public int					enableIKFixedAxisFlag			= -1;
			public int					enableIKSecondPassFlag			= 0;
			public float				secondPassLimitAngle			= -1.0f;

			public int					enableIKInnerLockFlag			= 0;
			...
			public int					enableIKMuscleFlag				= 0;
			...
			public int					nullBoneAnimationFlag			= 1; // 2014.11.22 Enabled
			...
			public int					enableFBXTexture				= 0;

			public int					supportVMDIKDisabled			= 1;
			public int					supportVMDPhysicsDisabled		= 1;

			public int					animKeyReductionFlag			= 1;
			public int					animNullAnimationFlag			= 0; // 2014.10.20 Turn off.(Remove legacy.)
			public int					animRootTransformFlag			= 0; // 2014.10.20 Turn off.(Remove legacy.)
	...
	public class MMDModel
	{
		...
		public class Material
		{
			...
			public string				materialName;	// Legacy.
			public string				translatedName;	// 2015.04.18 Added.
			public string				surfaceName;	// 2015.04.18 Added.
		...
		public class Morph
		{
			...
			public string				nameEn;
			public string				translatedName;	// 2015.04.18 Added.
			public string				blendShapeName;	// 2015.04.18 Added.
			...
			if( globalSettings != null && mmd4MecanimProperty != null ) {
				...
				if( pmx2fbxProperty.viewAdvancedGlobalSettings ) {
					...
					if( pmx2fbxProperty.viewAdvancedGlobalSettingsIK ) {
						...
						globalSettings.enableIK = EditorGUILayout.Toggle( "EnableIK", globalSettings.enableIK != 0 ) ? 1 : 0;
						globalSettings.ikLoopMinIterations = EditorGUILayout.IntField( "IKLoopMinIterations", globalSettings.ikLoopMinIterations );
						globalSettings.keepIKTargetBoneFlag = EditorGUILayout.Toggle( "KeepIKTargetBone", globalSettings.keepIKTargetBoneFlag != 0 ) ? 1 : 0;
						globalSettings.forceIKResetBoneFlag = EditorGUILayout.Toggle( "ForceIKResetBone", globalSettings.forceIKResetBoneFlag != 0 ) ? 1 : 0;

						globalSettings.enableIKFixedAxisFlag = EditorGUILayout.IntField( "IKFixedAxis", globalSettings.enableIKFixedAxisFlag );
						globalSettings.enableIKSecondPassFlag = EditorGUILayout.BeginToggleGroup( "IKSecondPass", globalSettings.enableIKSecondPassFlag != 0 ) ? 1 : 0;
						globalSettings.secondPassLimitAngle = EditorGUILayout.FloatField( "SecondPassLimitAngle", globalSettings.secondPassLimitAngle );
						...
						GUI.enabled = guiEnabled && (globalSettings.enableIKMuscleFlag != 0);
					...
					globalSettings.boneRenameFlag = EditorGUILayout.Toggle( "BoneRename", globalSettings.boneRenameFlag != 0 ) ? 1 : 0;
					globalSettings.prefixBoneRenameFlag = EditorGUILayout.Toggle( "PrefixBoneRename", globalSettings.prefixBoneRenameFlag != 0 ) ? 1 : 0;
					globalSettings.prefixBoneNoNameFlag = EditorGUILayout.Toggle( "PrefixBoneNoName", globalSettings.prefixBoneNoNameFlag != 0 ) ? 1 : 0;
					globalSettings.prefixNullBoneNameFlag = EditorGUILayout.Toggle( "PrefixNullBoneName", globalSettings.prefixNullBoneNameFlag != 0 ) ? 1 : 0;
					globalSettings.morphRenameFlag = EditorGUILayout.Toggle( "MorphRename", globalSettings.morphRenameFlag != 0 ) ? 1 : 0;
					globalSettings.prefixMorphNoNameFlag = EditorGUILayout.Toggle( "PrefixMorphNoName", globalSettings.prefixMorphNoNameFlag != 0 ) ? 1 : 0;
					globalSettings.materialRenameFlag = EditorGUILayout.Toggle( "MaterialRename", globalSettings.materialRenameFlag != 0 ) ? 1 : 0;
					globalSettings.prefixMaterialNoNameFlag = EditorGUILayout.Toggle( "PrefixMaterialNoName", globalSettings.prefixMaterialNoNameFlag != 0 ) ? 1 : 0;
					globalSettings.escapeMaterialNameFlag = EditorGUILayout.Toggle( "EscapeMaterialName", globalSettings.escapeMaterialNameFlag != 0 ) ? 1 : 0;
					EditorGUILayout.Separator();

					globalSettings.boneMorphFlag = EditorGUILayout.Toggle( "BoneMorph", globalSettings.boneMorphFlag != 0 ) ? 1 : 0;
					...
					EditorGUILayout.Separator();
					globalSettings.enableFBXTexture = EditorGUILayout.Toggle( "EnableFBXTexture", globalSettings.enableFBXTexture != 0 ) ? 1 : 0;
					EditorGUILayout.Separator();
					...
					globalSettings.animKeyReductionFlag = EditorGUILayout.Toggle( "AnimKeyReduction", globalSettings.animKeyReductionFlag != 0 ) ? 1 : 0;
