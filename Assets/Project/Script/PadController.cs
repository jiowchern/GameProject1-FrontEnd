...
{
    private Regulus.Project.ItIsNotAGame1.Data.IMoveController _MoveController;
    ...
    private void MoveControllerProvider_Supply(Regulus.Project.ItIsNotAGame1.Data.IMoveController obj)
    {
        _MoveController = obj;
