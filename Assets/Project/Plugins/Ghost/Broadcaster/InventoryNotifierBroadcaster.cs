...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class InventoryNotifierBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IInventoryNotifier> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public InventoryNotifierBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IInventoryNotifier>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IInventoryNotifier obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IInventoryNotifier obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IInventoryNotifier>{}
