...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class AccountManagerBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountManager> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public AccountManagerBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountManager>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IAccountManager obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IAccountManager obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IAccountManager>{}
