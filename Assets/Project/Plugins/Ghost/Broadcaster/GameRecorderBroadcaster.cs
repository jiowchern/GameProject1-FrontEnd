...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class GameRecorderBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IGameRecorder> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public GameRecorderBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IGameRecorder>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IGameRecorder obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IGameRecorder obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IGameRecorder>{}
