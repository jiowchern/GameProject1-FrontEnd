...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class StorageCompetencesBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IStorageCompetences> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public StorageCompetencesBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IStorageCompetences>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IStorageCompetences obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IStorageCompetences obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IStorageCompetences>{}
