...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class AccountStatusBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountStatus> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public AccountStatusBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountStatus>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IAccountStatus obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IAccountStatus obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IAccountStatus>{}
