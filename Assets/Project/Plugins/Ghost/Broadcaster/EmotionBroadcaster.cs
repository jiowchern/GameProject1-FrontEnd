...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class EmotionBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IEmotion> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public EmotionBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IEmotion>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IEmotion obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IEmotion obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IEmotion>{}
