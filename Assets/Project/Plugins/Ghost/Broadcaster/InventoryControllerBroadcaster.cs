...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class InventoryControllerBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IInventoryController> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public InventoryControllerBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IInventoryController>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IInventoryController obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IInventoryController obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IInventoryController>{}
