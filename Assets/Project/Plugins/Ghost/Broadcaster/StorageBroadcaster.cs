...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class StorageBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IStorage> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public StorageBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IStorage>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IStorage obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IStorage obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IStorage>{}
