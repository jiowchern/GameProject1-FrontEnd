...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class AccountCreatorBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountCreator> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public AccountCreatorBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountCreator>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IAccountCreator obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IAccountCreator obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IAccountCreator>{}
