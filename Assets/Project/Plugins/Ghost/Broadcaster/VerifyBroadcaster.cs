...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class VerifyBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IVerify> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public VerifyBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IVerify>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IVerify obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IVerify obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IVerify>{}
