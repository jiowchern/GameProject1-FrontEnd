...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class NormalSkillBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.INormalSkill> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public NormalSkillBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.INormalSkill>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.INormalSkill obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.INormalSkill obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.INormalSkill>{}
