...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class VisibleBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IVisible> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public VisibleBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IVisible>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IVisible obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IVisible obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IVisible>{}
