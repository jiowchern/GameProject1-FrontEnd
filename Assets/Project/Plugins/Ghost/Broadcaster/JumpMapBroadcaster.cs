...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class JumpMapBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IJumpMap> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public JumpMapBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IJumpMap>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IJumpMap obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IJumpMap obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IJumpMap>{}
