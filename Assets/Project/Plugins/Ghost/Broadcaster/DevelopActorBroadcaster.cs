...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class DevelopActorBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IDevelopActor> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public DevelopActorBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IDevelopActor>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IDevelopActor obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IDevelopActor obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IDevelopActor>{}
