...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class PlayerProperysBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IPlayerProperys> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public PlayerProperysBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IPlayerProperys>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IPlayerProperys obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IPlayerProperys obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IPlayerProperys>{}
