...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class BagNotifierBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IBagNotifier> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public BagNotifierBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IBagNotifier>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IBagNotifier obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IBagNotifier obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IBagNotifier>{}
