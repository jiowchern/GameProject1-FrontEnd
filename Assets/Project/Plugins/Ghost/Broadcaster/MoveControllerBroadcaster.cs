...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class MoveControllerBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IMoveController> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public MoveControllerBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IMoveController>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IMoveController obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IMoveController obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IMoveController>{}
