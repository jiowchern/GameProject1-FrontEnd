...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class EquipmentNotifierBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IEquipmentNotifier> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public EquipmentNotifierBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IEquipmentNotifier>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IEquipmentNotifier obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IEquipmentNotifier obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IEquipmentNotifier>{}
