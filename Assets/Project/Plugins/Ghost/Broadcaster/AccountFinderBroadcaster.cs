...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class AccountFinderBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountFinder> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public AccountFinderBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IAccountFinder>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IAccountFinder obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IAccountFinder obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IAccountFinder>{}
