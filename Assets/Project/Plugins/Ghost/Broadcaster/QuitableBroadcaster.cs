...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class QuitableBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IQuitable> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public QuitableBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IQuitable>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IQuitable obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IQuitable obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IQuitable>{}
