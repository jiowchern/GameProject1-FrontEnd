...
namespace Regulus.Project.ItIsNotAGame.Data{ 
    public class BattleSkillBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.ItIsNotAGame1.Data.IBattleSkill> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public BattleSkillBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.ItIsNotAGame1.Data.IBattleSkill>();
        ...
        private void _Unsupply(Regulus.Project.ItIsNotAGame1.Data.IBattleSkill obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.ItIsNotAGame1.Data.IBattleSkill obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.ItIsNotAGame1.Data.IBattleSkill>{}
