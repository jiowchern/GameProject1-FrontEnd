    ...
    { 
        public class CIVersion : Regulus.Project.ItIsNotAGame1.Data.IVersion , Regulus.Remoting.IGhost
        {
            ...
            public CIVersion(Regulus.Remoting.IGhostRequest requester , Guid id,Regulus.Remoting.ReturnValueQueue queue, bool have_return , Regulus.Serialization.ISerializer serializer)
            {
            ...
            {
                Regulus.Remoting.AgentCore.CallEvent(name_event , "CIVersion" , this , args, _Serializer);
            }
            ...
            {
                Regulus.Remoting.AgentCore.UpdateProperty(name , "CIVersion" , this , value );
            }
