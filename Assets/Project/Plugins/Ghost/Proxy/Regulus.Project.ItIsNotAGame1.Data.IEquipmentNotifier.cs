    ...
    { 
        public class CIEquipmentNotifier : Regulus.Project.ItIsNotAGame1.Data.IEquipmentNotifier , Regulus.Remoting.IGhost
        {
            ...
            public CIEquipmentNotifier(Regulus.Remoting.IGhostRequest requester , Guid id,Regulus.Remoting.ReturnValueQueue queue, bool have_return , Regulus.Serialization.ISerializer serializer)
            {
            ...
            {
                Regulus.Remoting.AgentCore.CallEvent(name_event , "CIEquipmentNotifier" , this , args, _Serializer);
            }
            ...
            {
                Regulus.Remoting.AgentCore.UpdateProperty(name , "CIEquipmentNotifier" , this , value );
            }
