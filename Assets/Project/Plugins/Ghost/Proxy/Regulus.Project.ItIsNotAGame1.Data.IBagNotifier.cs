    ...
    { 
        public class CIBagNotifier : Regulus.Project.ItIsNotAGame1.Data.IBagNotifier , Regulus.Remoting.IGhost
        {
            ...
            public CIBagNotifier(Regulus.Remoting.IGhostRequest requester , Guid id,Regulus.Remoting.ReturnValueQueue queue, bool have_return , Regulus.Serialization.ISerializer serializer)
            {
            ...
            {
                Regulus.Remoting.AgentCore.CallEvent(name_event , "CIBagNotifier" , this , args, _Serializer);
            }
            ...
            {
                Regulus.Remoting.AgentCore.UpdateProperty(name , "CIBagNotifier" , this , value );
            }
