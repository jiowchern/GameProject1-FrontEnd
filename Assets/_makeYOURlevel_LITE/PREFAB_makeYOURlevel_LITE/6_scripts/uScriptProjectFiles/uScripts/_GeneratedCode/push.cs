...
public class push : uScriptLogic
{
   ...
   UnityEngine.GameObject logic_uScriptAct_AddForce_Target_1 = default(UnityEngine.GameObject);
   ...
   UnityEngine.CharacterController event_UnityEngine_GameObject_Controller_0 = default(UnityEngine.CharacterController);
   ...
   {
      {
         ...
         {
            int index = 0;
            if ( logic_uScriptCon_GameObjectHasTag_Tag_11.Length <= index)
            {
               System.Array.Resize(ref logic_uScriptCon_GameObjectHasTag_Tag_11, index + 1);
            }
            logic_uScriptCon_GameObjectHasTag_Tag_11[ index++ ] = local_12_System_String;
